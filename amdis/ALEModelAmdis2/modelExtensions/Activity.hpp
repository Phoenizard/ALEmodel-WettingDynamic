...
public:
    ...
    void closeTimestep(AdaptInfo& adaptInfo) override {
        ...
        if (adaptInfo.timestepNumber()%every == 0 || adaptInfo.time() == adaptInfo.timestep()) {
            ...
            surfaceValueOf(muS_2,partitions_,0) << X(1)*(k0_* nschProb_.solution(_mu) + kOn_ * clamp(nschProb_.solution(_phiS),0.0,1.0)
                                                         - k0_ * molecularSurfaceArea_/molecularBulkVol_ * nschProb_.solution(_muGamma)
                                                         - kOff_ * nschProb_.solution(_phiGamma));

            surfaceValueOf(muS2_2,partitions_,0) << X(1)*X(1)*(k0_* nschProb_.solution(_mu) + kOn_ * clamp(nschProb_.solution(_phiS),0.0,1.0)
                                                               - k0_ * molecularSurfaceArea_/molecularBulkVol_ * nschProb_.solution(_muGamma)
                                                               - kOff_ * nschProb_.solution(_phiGamma));
            ...
            if (newS) {
                surfaceValueOf(muS_2, partitions_, 0)
                        << X(1) * (k0_ * nschProb_.solution(_mu) + kOn_ * (1.0 - nschProb_.solution(_phiGamma))
                                   -
                                   k0_ * molecularSurfaceArea_ / molecularBulkVol_ * nschProb_.solution(_muGamma)
                                   - kOff_ * nschProb_.solution(_phiGamma) * clamp(nschProb_.solution(_phiS),0.0,1.0));
    ...
    void writeFiles() override {
        ...
        surfaceValueOf(muS3,nschProb_.partitionsRef(),0) << k0_* nschProb_.solution(_mu) + kOn_ * clamp(nschProb_.solution(_phiS),0.0,1.0)
                                                           - k0_ * molecularSurfaceArea_/molecularBulkVol_ * nschProb_.solution(_muGamma)
                                                           - kOff_ * nschProb_.solution(_phiGamma);
