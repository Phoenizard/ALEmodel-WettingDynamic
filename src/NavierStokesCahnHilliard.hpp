...
namespace AMDiS
{
    ...
    public:
        ...
        auto nuPhase() {
            ...
            valueOf(*nuDOF_) << clamp(getOldPhase(), -0.6249, 0.3751) * nuInt
                                     + (0.3751 - clamp(getOldPhase(),-0.6249, 0.3751))*nuExt*valueOf(elementVectorOut)
                                       + (0.3751 - clamp(getOldPhase(),-0.6249, 0.3751))*nuInExt*valueOf(elementVectorIn);
